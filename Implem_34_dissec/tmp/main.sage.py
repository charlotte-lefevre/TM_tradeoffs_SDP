...
_sage_const_3 = Integer(3); _sage_const_560 = Integer(560); _sage_const_379 = Integer(379); _sage_const_34 = Integer(34); _sage_const_0p948366 = RealNumber('0.948366'); _sage_const_0 = Integer(0)
import numpy as np
