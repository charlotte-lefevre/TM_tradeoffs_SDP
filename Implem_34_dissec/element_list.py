...
# * <tt>linear_combin_trunc</tt>: it is equal to <tt>linear_combin</tt> on a slice which is the one on which we want to do a merging. For performance sreasosn it is impelmented as an integer
class element_list:
