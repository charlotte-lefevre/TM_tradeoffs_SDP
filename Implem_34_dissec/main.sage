...
parser.add_argument("-r", "--nbrun", dest="nbruns", help="Number of runs of SDP, default to one", type=int, default=1)
...
print("Average number of iterations needed to solve SDP: " + str(RR(avg_iter/args.nbruns)))
